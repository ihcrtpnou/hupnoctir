/*
 *  views / autocomplete.js
 *
 *  Creates the autocomplete portion in the home/landing page of the application.
 *  The initialization function of homeView.js calls the constructor for this object.
 *  The input and the cities collection is passed in.
 *
 */
...
var AutoCompleteView = Backbone.View.extend({
    ...
    /*
        On render - bind keyup and keydown, then load DOM.
    */
    render: function () {
    ...
    /*
        Key down pressed listeners
    */
    keydown: function (event) {
        if (event.keyCode == 38) return this.move(-1);      // arrow key up
        if (event.keyCode == 40) return this.move(+1);      // arrow key down
        if (event.keyCode == 13) return this.onEnter();     // enter key 
        if (event.keyCode == 27) return this.hide();        // esc key
    },
